...
/**
 * @brief Este Modulo intercambia los valores (pares) de un vector de entrada a un vector de salida, y saca este ultimo por pantalla
 ...
 * @post Los numeros de salida seran solo pares
 * @autor Pablo
 * @version 1.0 Fp DAM
 */
