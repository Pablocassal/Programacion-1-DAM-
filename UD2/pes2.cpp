...
int main (){
	...
	if ((x_porteria <= x_porteria0) || (y_porteria <= y_porteria0)) {		
		...
		if ((y_porteria == y_porteria0) && (x_porteria == x_porteria0)) {
			cout << endl << endl << "La porteria diseñada es imposible.(Es un punto) " << endl;			
		...
		//RECTA VERTICAL
		else if ((y_porteria != y_porteria0) && (x_porteria == x_porteria0)) {
			cout << endl << endl << "La porteria diseñada es imposible.(Es una recta vertical) " << endl;
			cout << "¿Quieres continuar? [S]i / [N]o :";
			cin >> opcion;
			cout << endl;
		...
		//RECTA HORIZONTAL
			...
			cout << endl << endl << "La porteria diseñada es imposible.(Es una recta horizontal) " << endl;
			cout << "¿Quieres continuar? [S]i / [N]o :";
			cin >> opcion;
			cout << endl;
		...
		//PORTERIA AL REVES
		else if ( ((x_porteria < x_porteria0) || (y_porteria < y_porteria0)) && ((y_porteria != y_porteria0) || (x_porteria != x_porteria0)) ) {
